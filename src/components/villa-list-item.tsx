  ...
  return (
    <article className="group relative grid grid-cols-1 overflow-hidden rounded-2xl border border-border/60 bg-card shadow-sm transition-shadow hover:shadow-md md:grid-cols-[420px_minmax(0,1fr)_240px]">
      ...
      <div className="flex flex-col border-t border-border/60 bg-muted/30 p-4 md:border-l md:border-t-0 lg:p-5">
        <div className="flex flex-1 items-center justify-between gap-3 md:flex-col-reverse md:items-stretch md:justify-center md:gap-3">
          <span className="inline-flex shrink-0 items-center justify-center gap-1.5 rounded-md bg-muted px-2.5 py-1.5 text-xs font-medium text-foreground md:mx-auto md:self-center">
